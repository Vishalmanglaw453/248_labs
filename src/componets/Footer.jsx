  ...
  return (
    <div>
      <footer className=" overflow-hidden">
        <div className="container2 pt-lg-0 pt-112">
          ...
          <ul className="mb-0 ps-0 d-flex align-items-center justify-content-center pt-3 gap-24 ">
            <li>
              <a
                href="#home"
          ...
          <div className=" d-flex align-items-center gap-3 justify-content-center pt-24">
            <a className="footer_svg_hover" target="blank" href="https://twitter.com/?lang=en">
              {" "}
              <div className="social_icon_box d-flex justify-content-center align-items-center">
                <svg
                  width="22"
                  height="23"
                  viewBox="0 0 22 23"
            ...
            <a className="footer_svg_hover" target="blank" href="https://www.facebook.com/">
              {" "}
              <div className="social_icon_box d-flex justify-content-center align-items-center">
                <svg
                  width="12"
            ...
            <a className="footer_svg_hover" target="blank" href="https://www.instagram.com/">
              {" "}
              <div className="social_icon_box d-flex justify-content-center align-items-center">
                <svg
                  width="17"
            ...
            <a className="footer_svg_hover" target="blank" href="https://in.indeed.com/">
              {" "}
              <div className="social_icon_box d-flex justify-content-center align-items-center">
                <svg
                  width="17"
        ...
        <div className="container2 position-relative">
          <p className=" ff-roboto fw-400 text-14 lh-16 pb-23 text-white text-center opacity_6">
            © 2024  248 Labs. All rights reserved
          </p>
          <div className=" footer_ellipe1 d-none d-lg-block">
          </div>
          <div className="footer_ellipe2 d-none d-lg-block"></div>
        </div>
      </footer>
    </div>
  );
